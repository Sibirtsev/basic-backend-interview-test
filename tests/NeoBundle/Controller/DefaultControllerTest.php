...
class DefaultControllerTest extends WebTestCase
{
    ...
    public function testBestMonthNonHazardous()
    {
        $client = static::createClient();
        ...
        $crawler = $client->request('GET', '/neo/best-month?hazardous=false');
        $responseWithParam = $client->getResponse()->getContent();

        $crawler = $client->request('GET', '/neo/best-month?hazardous=hello');
        $responseWithWrongParam = $client->getResponse()->getContent();
        ...
        $this->assertArrayHasKey('best-month', $data);

        $this->assertEquals('2017-03', $data['best-month']);
    }


    public function testBestMonthHazardous()
    {
        $client = static::createClient();
        ...
        $crawler = $client->request('GET', '/neo/best-month?hazardous=true');
        $responseWithParam = $client->getResponse()->getContent();
        ...
        $this->assertEquals('2016-05', $data['best-month']);
    }
}
